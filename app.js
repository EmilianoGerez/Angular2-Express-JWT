...
var counterModel = require('./server/models/counter.server.model');
...
// Routes middleware
var routes = require('./server/routes/index.server.routes');
var users = require('./server/routes/users.server.routes');
var auth = require('./server/routes/auth.server.routes');
